...
//     if (directOrder) {
//       dispatch(placeDirectOrder({productId: directOrder._id, deliveryType}))
//         .unwrap()
//         .then(() => {
...
//                 ₹{directOrder ? item.price : item.price * item.quantity}
//               </Text>
//             </View>
//           </View>
//         )}
...
//           Total: ₹{directOrder ? directOrder.price : totalCartPrice}
//         </Text>
//         <ButtonField
