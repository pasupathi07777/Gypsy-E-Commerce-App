...
//                 <th key={index} className="px-4 capitalize">
//                   {col.header}
//                 </th>
//               ))}
                    ...
                    >
                      {col.field === "index" ? (
                        ...
                        <div className="flex space-x-2 min-w-40">
                          {row.photos.map((photo, idx) => (
                            <img
                              ...
                              src={photo}
                              alt={`Product ${idx + 1}`}
                              className="w-[30px] h-[30px]  hover:scale-[200%] object-contain"
                            />
                          ))}
                        </div>
                      ) : col.field === "image" ? (
                        <img
                          src={row.image}
                          alt="Category"
                          className="w-[30px]  hover:scale-[200%] h-[30px] object-cover"
                        />
                      ) : col.field === "description" ? (
                        ...
                        row[col.field] // Keep email as it is
                      ) : col.render ? (
                        col.render(row)
                      ) : typeof row[col.field] === "string" ? (
                        capitalizeFirstLetter(row[col.field]) // Capitalize only the first letter
                      ) : (
                        row[col.field]
                      )}
                    </td>
